				...
				`;
					...
					<div class="questionContainer">
					  ...
					  <div class="contentWrapper">
						...
						<div><img class="ImageQuestion zoomable" id="zoomableImage" src="${questionData.images}" alt="Q"></img><br><div class="redtext1">${parent.ImageZoomText}</div></div>
				...
				questionHtml = `
					...
					<div class="questionContainer" >
						...
						<div class="question">${questionData.question}<div class="redtext">${parent.QuestionMcQtext}</div><div class="redtext">${parent.ImageZoomText}</div></div>
						 <div class="contentWrapper">
						<div class="options1">${optionsHtml}<button class="btn" id="submitBtn" disabled>${parent.quizButton}</button></div>
						<img class="ImageQuestion" src="${questionData.images}" alt="Q">	<div class="redtext">${parent.ImageZoomText}</div></img>					 
					  </div>
						<div class="feedback" id="feedback"></div>
					</div>
