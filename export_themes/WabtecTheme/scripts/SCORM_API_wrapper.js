...
function SCOReportSessionTime() { 
		...
		// --------------- Updated by Gopi.S -------------------------------------------
		elapsedTime=ORGformatelapsedTime(n);
		//alert("Function 1 : "+elapsedTime +" "+scorm.version);
        switch(scorm.version){ 
                        case "1.2" : success = scorm.set("cmi.core.session_time",elapsedTime); break; 
                        case "2004": success = scorm.set("cmi.session_time",elapsedTime); break; 
                } 
		//-------------------------------------------------------------------------------
} 
