...
class Landing extends BaseController
{
    ...
    //                 $user['lang'] = $this->request->getLocale();
    ...
    //                 //  $session['home_page'] = 1;
    //                 if ($usersessiondata['isLoggedIn'] != 1 && (empty($usersessiondata['client'])) && (empty($usersessiondata['userlevel']))) {
    ...
    //                 }
    //             } else {
    //                 session()->setFlashdata('error', 'Sorry! Validity has been expired. Please contact Admin.');
    //                 return redirect()->to(base_url() . 'login');
    //             }
    //         }
    //     }
