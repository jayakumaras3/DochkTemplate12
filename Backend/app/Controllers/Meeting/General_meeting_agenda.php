...
class General_meeting_agenda extends BaseController
{
    private $db;
    ...
    public function index() //fetch data from users table to display
    {
        if (!session()->get('isLoggedIn')) {
            ...
            $data['meetingagendaheader'] = $this->meeting_model->meetingallagendaheader_view($data['cid']);
           ...
           if ($this->request->getPost()) {
                ...
                if (!$this->validate($rulesData, $errors)) {
                    ...
                    if ($result) {
                        ...
                        return redirect()->to(base_url() . '/general_meeting_agenda');
                    } else {
    ...
    public function editagenda_header()
    {
        ...
        $data['clientusers'] = $this->meeting_model->getclientusers();
        ...
        echo view('templates/header_view', $data);
        echo view('general_meeting/edit_agenda_view', $data);
        echo view('templates/footer_view');
    }
        ...
        if (!session()->get('isLoggedIn')) {
           ...
           if ($this->request->getPost()) {
                ...
                if (!$this->validate($rulesData)) {
                    ...
                    if ($result) {
                        session()->setFlashdata('success', lang('Messages.Success_0011'));
                        return redirect()->to(base_url() . '/general_meeting_agenda/editagenda_header');
                    } else {
                        session()->setFlashdata('error', lang('Messages.Error_0003'));
                        session()->setFlashdata('alert-class', 'alert-danger');
                        return redirect()->to(base_url() . '/general_meeting_agenda/editagenda_header');
    ...
    function meeting_agenda_edit()
    {
        ...
        echo view('templates/header_view', $data);
        echo view('general_meeting/edit_agenda_disccussion', $data);
        echo view('templates/footer_view');
    }
        ...
        if (!session()->get('isLoggedIn')) {
           ...
           if ($this->request->getPost()) {
                ...
                if (!$this->validate($rulesData)) {
                    ...
                    if ($result) {
                        session()->setFlashdata('success', lang('Messages.Success_0008'));
                        return redirect()->to(base_url() . '/general_meeting_agenda/meeting_agenda_edit');
                    } else {
                        session()->setFlashdata('error', lang('Messages.Error_0003'));
                        session()->setFlashdata('alert-class', 'alert-danger');
                        return redirect()->to(base_url() . '/general_meeting_agenda/meeting_agenda_edit');
