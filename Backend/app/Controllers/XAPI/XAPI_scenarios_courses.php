...
class XAPI_scenarios_courses extends BaseController
{
    private $db;
    ...
    public function index()
    {
        ...
        $data['form_link'] = 'XAPI/XAPI_scenarios_courses/view_assigned_users';
        $data['form_seetinglink'] = 'XAPI/XAPI_scenarios_courses/viewScenarioSettings';
        $data['form_editlink'] = 'XAPI/XAPI_scenarios_courses/viewScenarioDetails';
    ...
    public function XAPIMangeCourses()
    {
        ...
        $data['course_header'] = 'AR/VR/Sim Courses';
        $data['course_header_link'] = 'XAPI/XAPI_courses';
        $data['form_link'] = 'XAPI/XAPI_scenarios_courses/view_Manageassigned_users';
        $data['form_seetinglink'] = 'XAPI/XAPI_scenarios_courses/viewScenarioSettings';
        $data['form_editlink'] = 'XAPI/XAPI_scenarios_courses/viewScenarioDetails';
        $data['header'] = 'Scenarios - ' . $data['course_name'];
        $data['scenarios'] = $this->xapi_scenarios_model->getAllScenarios($_SESSION['scourse_id']);
    ...
    public function createNewScenario()
    {
        ...
        if ($this->request->getPost()) {
            ...
            return redirect()->to(base_url() . 'XAPI/XAPI_scenarios_courses');
        }
    }
    ...
    public function viewScenarioDetails()
    {
        ...
        if (isset($scourse_id) && isset($course_name) && isset($xs)) {
            ...
            $_POST['xs'] = $xs;
            $_POST['scenario_name'] = $scenario_name;
            session()->remove('scourse_id');
            session()->remove('course_name');
            session()->remove('xs');
            session()->remove('scenario_name');
        }
        if (isset($_POST['scourse_id']) && isset($_POST['course_name'])) {
            $data['scourse_id'] = $_POST['scourse_id'];
            $_SESSION['scourse_id'] =  $data['scourse_id'];
        ...
        if (isset($_POST['scenario_name'])) {
            $data['scenario_name'] = $_POST['scenario_name'];
            $_SESSION['scenario_name'] =  $data['scenario_name'];
        }
        $data['course_header'] = 'AR/VR/Sim Courses';
        $data['course_header_link'] = 'XAPI/XAPI_courses';
        $data['header'] = 'Scenarios - ' . $data['scenario_name'];
        $data['header_link'] = 'XAPI/XAPI_scenarios_courses';
        $data['header2'] = 'Edit Scenarios';
        $data['updateScenario'] = 'XAPI/XAPI_scenarios_courses/updateScenario';
        $data['assignUserScenario'] = 'XAPI/XAPI_scenarios_courses/editAssignedScenariouser';
        $data['deleteAssignedUser'] = 'XAPI/XAPI_scenarios_courses/deleteAssignedScenariouser';
        ...
        // print_r($data['getAssignedScenarioUsers']);
        // exit();
        echo view('templates/header_view', $data);
    ...
    public function viewScenarioSettings()
    {
        ...
        $data['settings_form'] = 'XAPI/XAPI_scenarios_courses/changeSenarioSettingValues';
    ...
    public function updateScenarioSettingsDetails()
    {
        ...
        if ($this->request->getPost()) {
            ...
            return redirect()->to(base_url() . '/XAPI/XAPI_scenarios_courses/viewScenarioSettings');
        }
    }
    ...
    public function changeSenarioSettingValues()
    {
        ...
        $data['header2_link'] = 'XAPI/XAPI_scenarios_courses/viewScenarioSettings';
        $data['header3'] = 'Edit Scenarios Settings Values';
        $data['edit_link'] = 'XAPI/XAPI_scenarios_courses/updateScenarioSettingsDetails';
    ...
    public function view_assigned_users()
    {
        ...
        $data['form_link1'] = 'XAPI/XAPI_scenarios_courses/deleteEnrollment';
    ...
    public function view_Manageassigned_users()
    {
        ...
        $data['course_header_link'] = 'XAPI/XAPI_courses';
        $data['header'] = 'Scenarios {' . $_SESSION['course_name'] . '}';
        $data['header_link'] = 'XAPI/XAPI_scenarios_courses/XAPIMangeCourses';
        $data['header2'] = 'Scenarios Users {' . $_SESSION['scenario_name'] . '}';
    ...
    function assignUserstoScenario()
    {
        ...
        if (isset($_POST['user_id']) && isset($_POST['role']) && isset($_POST['xs'])) {
            ...
            return redirect()->to(base_url() . 'XAPI/XAPI_scenarios_courses/viewScenarioDetails');
        }
        $postresult = $this->xapi_scenarios_model->getassignUserRoletoScenario($_POST['scourse_id'], $data['user_id']);
        session()->set('user_id',  $_POST['user_id']);
        session()->set('scourse_id',  $_POST['scourse_id']);
        session()->set('course_name',  $_POST['course_name']);
        session()->set('xs',  $data['scenario_id']);
        session()->set('scenario_name',  $_POST['scenario_name']);
        session()->set('role',   $data['role']);
        if ($postresult) {
            echo '<script>
            if (confirm("User already added to other Scenario. Do you want add to new Scenario?")) {
                // Proceed with deletion  
                window.location.href = "' . base_url() . 'XAPI/XAPI_scenarios_courses/reassignusertoscenario";
            } else {
                window.location.href = "' . base_url() . 'XAPI/XAPI_scenarios_courses/viewScenarioDetails";
            }
             </script>';
        } else {
            $newdata = [
    ...
    function editAssignedScenariouser()
    {
        ...
        $data['course_header_link'] = 'XAPI/XAPI_courses';
        $data['header'] = 'Scenarios {' . $_SESSION['course_name'] . '}';
        $data['header_link'] = 'XAPI/XAPI_scenarios_courses/viewScenarioDetails';
        $data['header2'] = 'Edit User Role';
        $data['edit_role'] = 'XAPI/XAPI_scenarios_courses/updateUserRole';
    ...
    function reassignusertoscenario()
    {
        ...
        $data['scourse_id'] = session()->get('scourse_id');
        $data['course_name'] = session()->get('course_name');
        $data['scenario_id'] = session()->get('xs');
        ...
        $scenarioresult = $this->xapi_scenarios_model->deleteAssigdOlderScenariouser($deletedata, $data['user_id'], $data['scourse_id']);
        if ($scenarioresult) {
            $newdata = [
