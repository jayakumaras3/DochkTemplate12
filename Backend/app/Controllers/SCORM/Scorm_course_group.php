...
class Scorm_course_group extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['form_link'] = 'SCORM/scorm_course_group/addcoursegroupval';
        $data['form_link_1'] = 'SCORM/scorm_course_group/add_courses';
        $data['form_link_2'] = 'SCORM/scorm_course_group/coursegroup_edit_view';
    ...
    {
        if ($response =  $this->requireRole(['6', '44', '5'])) {
            return $response;
        }
        $data = [];
        helper(['form']);
        ...
        if ($this->request->getPost()) {
            $description = htmlspecialchars($this->request->getVar('description'), ENT_QUOTES, 'UTF-8');
            ...
            return redirect()->to(base_url() . '/SCORM/scorm_course_group');
        }
    }
    public function coursegroup_edit_view()
    {
        ...
        $data['header_link'] = 'SCORM/scorm_courses';
        $data['sub_header_1'] = 'Course Group';
        $data['sub_header_1_link'] = 'SCORM/scorm_course_group';
        ...
        $data['form_link'] = 'SCORM/scorm_course_group/editcoursegpval?sc_cgid=' . $getcoursegroup[0]['sc_cgid'];
    ...
    public function add_courses()
    {
        ...
        $data['form_link'] = 'SCORM/scorm_course_group/add_course_to_group';
        $data['form_link_1'] = 'SCORM/scorm_course_group/delete_assigned_course';
    ...
    public function delete_assigned_course()
    {
        ...
        return redirect()->to(base_url() . '/SCORM/scorm_course_group/add_courses');
    }
}
