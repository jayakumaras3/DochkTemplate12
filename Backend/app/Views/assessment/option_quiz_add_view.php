<div class="row">
    <div class="col-md-12">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url($main_header_link); ?>"><?php echo $main_header; ?></a></li><b>&nbsp;>&nbsp;</b>
    ...
    <div class="col-md-12">
        <div class="x_panel">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    $folderloc = $baseloc . 'assets/uploads/assessment_image/' . $row['q_id'];
                    // print_r($folderloc);
                    // exit();
                    if (is_dir($folderloc)) {
                    ...
                    ?>
                                    <div class="head bg-dot30 np tac">
                                        <img style="max-height:100px;" src="<?php echo base_url() ?>/assets/uploads/assessment_image/<?php echo $row['q_id']; ?>/<?php echo $value ?>" class="img-squre img-thumbnail" />
                                    </div><br />
                                    <?php
        ...
        <div class="x_panel">
            ...
            <div class="col-md-6">
                ...
                $folderloc = $baseloc . 'assets/uploads/assessment_pdf/' . $row['q_id'];
                if (is_dir($folderloc)) {
                    $files2 = scandir($folderloc, SCANDIR_SORT_DESCENDING);
                    $sno = 0;
                    echo '<table class="table  table-sm">';
        ...
        <div class="x_panel">
            ...
            <div class="col-md-6">
                ...
                $folderloc = $baseloc . 'assets/uploads/assessment_video/' . $row['q_id'];
                if (is_dir($folderloc)) {
                    $files2 = scandir($folderloc, SCANDIR_SORT_DESCENDING);
                    $sno = 0;
                    echo '<table class="table  table-sm">';
