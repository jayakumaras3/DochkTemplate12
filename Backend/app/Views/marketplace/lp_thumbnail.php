            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a
                            href="<?php echo base_url('marketplace/Learning_dashboard/learning_courses') ?>"><?php echo lang('Buttons.Learning Courses'); ?></a></li>
                </ol>
            </div>
            <h4 class="page-title"><?php echo lang('Buttons.Upload_Thumbnail'); ?></h4>
        </div>
    </div>
</div>
<!-- end page title -->
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="mb-3 text-uppercase bg-light p-2"> <?php echo lang('Buttons.Thumbnail'); ?></h5>
...
<<<<<<< Updated upstream
                    <p style="color: red">Note: Standard format to upload Thumbnail Size : Max 200KB and
                        dimension 518x309.</p>
=======
                    <p style="color: red"><?php echo lang('Statements.State_0001'); ?></p>
>>>>>>> Stashed changes

                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="firstname" class="form-label"><?php echo lang('UI_Text.Upload_Thumbnail'); ?></label><br>
                    ...
                    <button type="submit" class="btn btn-outline-success waves-effect btn-sm waves-light mb-3"
                        id="submitButton"><i class="mdi mdi-content-save"></i> <?php echo lang('Buttons.Upload'); ?></button>
