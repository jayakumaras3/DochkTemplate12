                                ...
                                <div class="card product-box">
                                    ...
                                    <form class="form-horizontal" action="<?php echo base_url('my_training/read_more') ?>" method="POST"><?= csrf_field() ?>
                                        ...
                                        <form class="form-horizontal" action="<?php echo base_url('my_training/read_more') ?>"
                                            ...
                                            <input type="hidden" name="discount" value="<?php echo $course['discount']; ?>" ?>
                                    ...
                                    <img src="<?= $thumbnail ?>" alt="Course Thumbnail" class="img-fluid">
                                        ...
                                        <div class="product-info">
                                            <div class="row align-items-center">
                                                <h5 class="font-16 mt-0 sp-line-1"><span
                                                        class="text-dark"><?php echo $course['course_name']; ?></span> </h5>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <?php if ($course['language']) { ?>
                                                        <h6 class="m-1"> <span class="text-muted"> <?php echo lang('UI_Text.Language'); ?> :
                                                                <?php echo $course['language']; ?></span></h6>
                                                    <?php } ?>
                                                    <?php if ($course['duration']) { ?>
                                                        <h6 class="m-1"> <span class="text-muted"> <?php echo lang('UI_Text.Duration'); ?> :
                                                                <?php echo $course['duration']; ?> <?php echo lang('UI_Text.Minutes'); ?></span></h6>
                                                    <?php } ?>
                                                </div>
                                                <div class="col-auto">

                                                    <!-- <?php if ($price > 0 && $course['discount'] < 100) { ?>
                                                        <div class="product-price-tag">
                                                            <?php echo '$ ' . number_format($price, 2) - .01; ?>
                                                        </div>
                                                    <?php } ?> -->
                                                    <div class="col-auto">

                                                        <?php if ($price > 0 && $course['payment_type'] != 1 && $course['discount'] < 100) { ?>
                                                            <div class="product-price-tag">
