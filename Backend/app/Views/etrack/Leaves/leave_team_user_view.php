<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title">
               Apply Team Leave - <?php echo $user_name[0]['name'] . ' ' . $user_name[0]['last_name']; ?>
            </h4>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <form class="form-horizontal" action="<?php echo base_url('etrack/leaves/team_lead_apply_leaves'); ?>" method="POST"><?= csrf_field() ?>
                    <div class="row mb-3">
                    ...
                    <div class="justify-content-end row">
                        <div class="col-8 col-xl-9">
                            <input type="hidden" name="user_select" value="<?php echo $user_name[0]['id_user']; ?>">
