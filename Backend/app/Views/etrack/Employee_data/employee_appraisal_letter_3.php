                    ...
                    <div class="col-sm-12  mt-2">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>In recognition of this contribution, we are very pleased to inform you that you are being promoted to the post of <strong><?php echo $appraisal_letter[0]['designation']; ?></strong> and your compensation has been revised to Rs. <strong><?php echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $appraisal_letter[0]['yearly']); ?>/-</strong> CTC per annum, with effect from <strong><?php echo date('F d, Y', strtotime($appraisal_letter[0]['effectivedate'])); ?></strong>. </p>
