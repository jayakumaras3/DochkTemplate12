                        ...
                        <div class="card">
                            <div class="card-body">
                                <p><strong>Employee Name : </strong> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $appraisal_letter[0]['fname'] . ' ' . $appraisal_letter[0]['last_name']; ?></br>
                                    <strong>Employee ID : </strong> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $appraisal_letter[0]['emp_id']; ?></br>
                                    <strong>Designation : </strong> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $appraisal_letter[0]['designation']; ?>
                                </p>
                            </div><!-- end col -->
                        </div>
                    </div><!-- end col -->
                    ...
                    <div class="col-sm-12  mt-2">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>We hope that you continue to meet all challenges consistently with the growth of the organization.</p>

                                <p>In recognition of this contribution, we are pleased to inform you that your
                                    annual compensation has been revised to Rs. <strong><?php echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $appraisal_letter[0]['yearly']); ?>/-</strong> CTC per annum effective from <strong><?php echo date('F d, Y', strtotime($appraisal_letter[0]['effectivedate'])); ?></strong>.</p>

                                <p>Your salary details are strictly private and confidential and details in this letter must not be disclosed and discussed to others. All the other terms and conditions remain unchanged. </p>

                                <p>Congratulations on your success and wishing you all the best for the year ahead.</p>
                                ...
                                <?php if ($appraisal_letter[0]['iagree'] == 0) { ?>
                                    <?php if ($return_page == 1) { ?>
                                        <div class="row">
                                            <div class="col-12">
                                                <p>Please acknowledge your acceptance of the revised terms by selecting the Accept button.</p>
                                            </div>
                                            <div class="col-6">
