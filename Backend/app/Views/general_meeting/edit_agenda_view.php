<div class="row">
    <div class="col-md-12">
        <ol class="breadcrumb">
            <li>
                <a href="<?php echo base_url('general_meeting_agenda') ?>">Back</a>
            </li><b>&nbsp;>&nbsp;</b>
    ...
    <div class="col-md-12">
        <div class="block">
            ...
            <div class="x_panel">
                ...
                <a href="<?php echo base_url('general_meeting_agenda/export_meeting_agenda?id_m=' . $id_m); ?>"><button class="btn btn-sm btn-danger">Export Meeting agenda</button></a>
...
<div class="row">
    <div class="col-md-4">
        <div class="block">
            <div class="content">
                <div class="x_panel">
                    <form class="form" action="<?php echo base_url('general_meeting_agenda/add_attendees?id_m=' . $id_m) ?>" method="POST"><?= csrf_field() ?>

                        <div class="form-group col-md-12">
                            <select class="select2" style="width: 100%;" multiple="multiple" tabindex="-1" name="attendees[]" required="">
                                <?php foreach ($clientusers as $clienteachusers) { ?>

                                    <option value="<?= $clienteachusers['name'] ?>"><?php  ?><?= $clienteachusers['name'] ?></option>
                                <?php } ?>
                            </select>
    ...
    <div class="col-md-8">
        ...
        <div class="block">
            ...
            <div class="content">
                <div class="x_panel">
                    <form class="form" action="<?php echo base_url('general_meeting_agenda/updateagenda_header?id_m=' . $id_m) ?>" method="POST"><?= csrf_field() ?>
                        <div class="row">
                            <div class="col-md-3">
...
<div class="row">
    <div class="col-md-4">
        <div class="block">
            <div class="content">
                <div class="x_panel">
                    <form class="form" action="<?php echo base_url('general_meeting_agenda/addprojectstatus?id_m=' . $id_m) ?>" method="POST"><?= csrf_field() ?>
                        <div class="row-md-4">
                    ...
                    <table class="table  table-sm table-bordered">
                        ...
                        foreach ($meetingagendadata as $eachmeetingagendadata) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="<?php echo base_url('general_meeting_agenda/meeting_agenda_edit') ?>" method="POST"><?= csrf_field() ?>
                                        <input type="hidden" name="id_ma" value="<?php echo $eachmeetingagendadata['id_ma'] ?>">
                                        <button type="submit" class="btn btn-sm btn-warning">
                                            <span class="icon-pencil"></span></button>
                                    </form>
                                    <!-- <a href="<?php echo base_url('general_meeting_agenda/meeting_agenda_edit?id_ma=' . $eachmeetingagendadata['id_ma']); ?>"><button type="submit" class="widget-icon btn-warning"><span class="icon-pencil"></span></button></a> -->
                                </td>
                                <td><a onclick="return confirm('<?php echo lang('Alert.Aler_002') ?>')" href="<?php echo base_url('general_meeting_agenda/delmeeting_agenda?id_m=' . $eachmeetingagendadata['fk_id_m'] . '&id_ma=' . $eachmeetingagendadata['id_ma']); ?>"><button type="submit" class="btn btn-sm btn-danger"><span class="icon-trash"></span></button></a></td>
