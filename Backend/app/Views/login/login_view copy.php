...
<body class="auth-fluid-pages pb-0">
        ...
        <div class="auth-fluid-form-box">
            <div class="align-items-center d-flex h-100">
                <div class="p-3">
                    ...
                    <?php endif; ?>
                    <!-- form -->
                    <form action="<?php echo base_url('login'); ?>" method="POST"><?= csrf_field() ?>
                        <div class="mb-3">
                            <label for="emailaddress" class="form-label">Email address</label>
                            <input class="form-control" type="text" id="username" name="username" required="" placeholder="Enter your email" value="<?= set_value('username') ?>">
                        </div>
                        <div class="mb-3">
                            <a href="<?php echo base_url('forgot_password'); ?>" class="text-muted float-end"><small>Forgot your password?</small></a>
    ...
    <!-- Authentication js -->
    <script src="<?php echo base_url(); ?>/public/creative/assets/js/pages/authentication.init.js"></script>
