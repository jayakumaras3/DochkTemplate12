<div class="row">
    <div class="col-md-12">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('demo_users?id_c=' . $clientid); ?>">Users List</a></li><b> &nbsp;> &nbsp;</b>
    ...
    <div class="col-md-6">
        <div class="x_panel">
            <div class="block block-drop-shadow">
                <div class="content controls">
                    <form class="form" action="<?php echo base_url('demo_users/editUsers/' . $row['id_user'] . '/' . $clientid); ?>" method="POST"><?= csrf_field() ?>
                        <div class="form-row">
        ...
        <div class="x_panel">
            <div class="block block-drop-shadow">
                ...
                <div class="content controls">
                    <form class="form" action="<?php echo base_url('demo_users/psseditUsers/' . $row['id_user'] . '/' . $clientid); ?>" method="POST"><?= csrf_field() ?>
                        <div class="form-row">
        ...
        <div class="block">
            <div class="x_panel">
                ...
                <div class="content">
                    <form class="form-inline" action="<?php echo base_url('demo_users/updateCategory/' . $row['id_user'] . '/' . $clientid); ?>" method="POST"><?= csrf_field() ?>
                        <div class="form-row">
        ...
        <div class="block">
            <div class="x_panel">
                ...
                <div class="content">
                    <form class="form-inline" action="<?php echo base_url('demo_users/updateCategoryItem/' . $clientid .  '/' . $row['id_user']); ?>" method="POST"><?= csrf_field() ?>
                        <div class="form-row">
                        ...
                        <tbody>
                            <?php if (!empty($clientUserlevelData)) : foreach ($clientUserlevelData as $eachuserData) { ?>
                                    <tr>
                                        ...
                                        <td><a onclick="return confirm('<?php echo lang('Alert.Aler_002') ?>')" href="<?php echo base_url('demo_users/deleteUserCategory/' . $eachuserData['id_du'] . '/' . $eachuserData['id_user'] . '/' . $clientid) ?>" class="btn btn-sm widget-icon"><span class="icon-trash"></span></a></td>
                                    </tr>
                            <?php }
                            endif; ?>
                        </tbody>
