            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Select Langauge</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form">
                            <fieldset>
                                <?php foreach ($getlangdata as $geteachlangdata) { ?>
                                    <div class="form-group">
                                        <a href="<?php echo base_url('Emanual/emanual_link/link_v1/' . $emd_id . '/' . base64_encode($page_id) . '/' . base64_encode($geteachlangdata['lang_id'])) ?>" class="btn btn-lg btn-success btn-block"><?php echo $geteachlangdata['lang_name'] ?></a>
                                    </div>
                                <?php } ?>
                            </fieldset>
                        </form>
