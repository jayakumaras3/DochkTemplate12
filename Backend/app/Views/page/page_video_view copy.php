    ...
    <div class="container-fluid">
        <div class="row content">
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-1">
                        <button type="submit" class="btn btn-outline-primary waves-effect btn-xs waves-light" id="menu-btn">&#9776;</button>
                    </div>
                    <div class="col-sm-11">
                        <h4>
                ...
                <div class="row main-content">
                    <div class="col-sm-12 text-left">
                        ...
                        if ($row['type'] == 3) {
                            ...
                            $html_path = base_url() . "assets/assets/uploads/SCORM_course_document/" . $course_id . "/" . $coursedetails[0]['createdon'] . "/shared/assets/content/english/pages/page1/Screen_01.html"; ?>
                        ...
                        <?php } elseif ($row['type'] == 1) {
                            ...
                            $articulate_path = base_url() . "assets/assets/uploads/SCORM_course_document/" . $course_id . "/" . $coursedetails[0]['createdon'] . "/shared/assets/content/english/pages/" . $row['page_id'] . "/Articulate/story.html"; ?>
                            <div class="iframe-container">
                        ...
                        <?php } elseif ($row['type'] == 2) {
                            // Path for the video
                            $video_path = base_url() . "assets/assets/uploads/SCORM_course_document/" . $course_id . "/" . $coursedetails[0]['createdon'] . "/shared/assets/video/English/" . $row['video_upload'];
