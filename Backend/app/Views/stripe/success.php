...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>public/aristo_assets/stripe/style.css">
  <script src="<?php echo base_url(); ?>public/aristo_assets/stripe/client.js" defer></script>
</head>
...
<body>
  <section>
    ...
    <form action="<?php echo base_url('Stripe/Create_portal_session'); ?>" method="POST"><?= csrf_field() ?>
      <input type="hidden" id="session-id" name="session_id" value="<?php echo $session_id ?>" />
