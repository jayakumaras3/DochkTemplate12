									...
									<form class="form-horizontal" action="<?php echo base_url('Project/baseline/updatebaselinevalues') ?>" method="POST"><?= csrf_field() ?>
										<div class="row">
											<div class="form-group col-md-6 mb-3">
												<label>Name</label>
												<input type="text" class="form-control col-md-12" required name="description" value="<?php echo $baselineVal[0]['description']; ?>" />
											</div>
											<div class="form-group col-md-3">
												<label>Duration in Minutes</label>
												<input type="number" class="form-control col-md-12" required name="duration" value="<?php echo $baselineVal[0]['duration']; ?>" />
											</div>
										</div>
										<div class="row">
											<div class="form-group col-md-3 mb-3">
												<label>ID Effort</label>
												<input type="number" class="form-control col-md-12" name="ID" value="<?php echo $baselineVal[0]['ID']; ?>" />
											</div>
											<div class="form-group col-md-3">
												<label>CE Effort</label>
												<input type="number" class="form-control col-md-12" name="CE" value="<?php echo $baselineVal[0]['CE']; ?>" />
											</div>
											<div class="form-group col-md-3">
												<label>Viz Effort</label>
												<input type="number" class="form-control col-md-12" name="Viz" value="<?php echo $baselineVal[0]['Viz']; ?>" />
											</div>
											<div class="form-group col-md-3">
												<label>SME Effort</label>
												<input type="number" class="form-control col-md-12" name="SME" value="<?php echo $baselineVal[0]['SME']; ?>" />
											</div>
										</div>
										...
										<div class="row">
											<div class="form-group col-md-3 mb-3">
												...
												<input type="number" class="form-control col-md-12" name="VD" value="<?php echo $baselineVal[0]['VD']; ?>" />
											</div>
											<div class="form-group col-md-3">
												<label>Flash Effort</label>
												<input type="number" class="form-control col-md-12" name="flash" value="<?php echo $baselineVal[0]['flash']; ?>" />
											</div>
											<div class="form-group col-md-3">
												<label>3D Effort</label>
												<input type="number" class="form-control col-md-12" name="3D" value="<?php echo $baselineVal[0]['3D']; ?>" />
											</div>
											<div class="form-group col-md-3">
												<label>PP Effort</label>
												<input type="number" class="form-control col-md-12" name="PP" value="<?php echo $baselineVal[0]['PP']; ?>" />
											</div>
										</div>
										<div class="row">
											<div class="form-group col-md-3 mb-3">
												<label>Articulate</label>
												<input type="number" class="form-control col-md-12" name="Articulate" value="<?php echo $baselineVal[0]['Articulate']; ?>" />
											</div>
											<div class="form-group col-md-3">
												<label>Programmer</label>
												<input type="number" class="form-control col-md-12" name="Prog" value="<?php echo $baselineVal[0]['Prog']; ?>" />
											</div>
											<div class="form-group col-md-3">
												<label>Unity3D</label>
												<input type="number" class="form-control col-md-12" name="Unity" value="<?php echo $baselineVal[0]['Unity']; ?>" />
											</div>
										</div>
										<div class="row">
											<div class="form-group col-md-3 mb-3">
												<label>QA</label>
												<input type="number" class="form-control col-md-12" name="QA" value="<?php echo $baselineVal[0]['QA']; ?>" />
											</div>
											<div class="form-group col-md-3">
												<label>PMO</label>
												<input type="number" class="form-control col-md-12" name="PMO" value="<?php echo $baselineVal[0]['PMO']; ?>" />
											</div>
										</div>
										<div class="row">
