        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="<?php echo base_url('holiday/holidays/access'); ?>">Site Access</a></li>
                </ol>
            </div>
...
<div class="row">
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo base_url('holiday/holidays/editAccesslevel'); ?>" method="post" autocomplete="off">
                    <div class="col-lg-12 mb-2">
                        <label>Name - <?php echo $access_details[0]['id_ua']; ?> </label>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <form class="form-horizontal" action="<?php echo base_url('holidays/delete_access'); ?>" method="POST">
