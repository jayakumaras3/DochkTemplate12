...
<div id="player-container">
    <!-- <iframe width="560" height="315" src="https://www.youtube.com/embed/wE4lLcCvdhY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> -->
    <iframe id="player" src="<?= $videoUrl ?>" frameborder="0" allowfullscreen></iframe>
</div>
    <script>
        // Function to calculate and update iframe dimensions
        function adjustIframeSize() {
            var container = document.getElementById('player-container');
            var player = document.getElementById('player');

            var containerWidth = container.offsetWidth;
            var containerHeight = containerWidth * 9 / 19; // Maintain 16:9 aspect ratio

            player.style.width = containerWidth + 'px';
            player.style.height = containerHeight + 'px';
        }

        // Call the adjustIframeSize function initially and on window resize
        adjustIframeSize();
