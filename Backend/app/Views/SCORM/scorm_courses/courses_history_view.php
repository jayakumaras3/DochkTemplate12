...
<div class="row">
    <div class="col-md-12">
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url('projects') ?>"><?php echo $getCourseDetails['0']['projectname'] ?></a>
            </li><b> &nbsp;>&nbsp;</b>
            <li>
                <a href="<?php echo base_url('project_details?projectid=' . $projectid) ?>"><?php echo $getCourseDetails['0']['course_name'] ?></a>
            </li><b> &nbsp;>&nbsp;</b>
