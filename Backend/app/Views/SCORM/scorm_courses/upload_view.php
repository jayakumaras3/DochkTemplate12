<div class="row">
    <div class="col-md-12">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('scorm_courses') ?>">C4U Courses</a>
            </li><b> &nbsp;>&nbsp;</b>
...
<div class="row">
    <div class="col-md-4">
        <div class="x_panel">
            <div class="form-row">
                <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url('scorm_courses/uploadDocument') ?>" method="POST"><?= csrf_field() ?>
