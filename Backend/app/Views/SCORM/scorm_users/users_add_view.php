<div class="row">
    <div class="col-md-12">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('scorm_client') ?>">Scrom Client List</a></li><b> &nbsp;>&nbsp;</b>
                ...
                <div class="x_content">
                    ...
                    <div class="block block-drop-shadow">
                        <div class="content controls">
                            <form class="form" action=" <?php echo base_url('SCORM/scorm_User_login/users/register?cid=' . $clientid); ?>" method="POST"><?= csrf_field() ?>
