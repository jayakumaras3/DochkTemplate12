<div class="row">
    <div class="col-md-12">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('scorm_client') ?>">C4U Clients</a></li><b> &nbsp;> &nbsp;</b>
            ...
            <div class="col-md-4">
                <div class="x_panel">
                    <div class="block">
                        ...
                        <div class="content">
                            <form class="form" action="<?php echo base_url('scorm_client/saveEditClientlist'); ?>" method="POST"><?= csrf_field() ?>
