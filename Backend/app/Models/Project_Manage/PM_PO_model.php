...
class PM_PO_model extends Model
{
    ...
    public function get_milestone_edit_details(int $milestone_id): array
    {
    ...
    public function update_milestone_data(array $newdata, int $milestone_id): bool
    {
    ...
    public function add_ucn($newdata, $po_id)
    {
        ...
        if ($insertID) {
            ...
            $to = 'pramod.c@TouchstoneLC.com,shrikant.msp@touchstonelc.com';
