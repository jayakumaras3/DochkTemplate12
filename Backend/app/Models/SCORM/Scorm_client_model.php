...
class Scorm_client_model extends Model
{
    ...
    protected $allowedFields = ['name', 'url', 'start_date', 'end_date', 'courses_count', 'status', 'createdon', 'createdby', 'last_updated_by', 'last_updated_on', 'fk_id_dc'];
    ...
    public function getScormUserDetailsById($sc_uid)
    {
        ...
        $builder->select('s.sc_uid, sca.id_user as fk_user_id, u.client_id');
        ...
        foreach ($newdata['course_id'] as $course_id) {
            ...
            if (!$exists) {
                ...
                if ($insert_id) {
                   ...
                   $data = $db->table('scorm_user_details')->insert($detailsData);
